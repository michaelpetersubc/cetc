...
##CONSTRUCTING THE DATA_FRAME
  ...
  directory_name<-"C:/Users/HP/Documents/CETC RA/"
  ...
  Attendee_Report<-read_csv(paste0(directory_name,"Anonymous_attendee"),col_names = TRUE,col_types = cols(X1 = col_skip()))
  Panelist_Report<-read_csv(paste0(directory_name,"Anonymous_panelist"),col_names = TRUE,col_types = cols(X1 = col_skip()))
